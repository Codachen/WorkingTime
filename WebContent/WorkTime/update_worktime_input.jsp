...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="jobIntro" size="25"
			 value="<%= (workTimeVO==null)? "工作項目說明" : workTimeVO.getJobIntro()%>" /></td>
	</tr>
	
	<tr>
		<td>工作開始時間:</td>
		<td><input name="workTimeStart" id="starttime" type="text" 
		 value="<fmt:formatDate value='${workTimeVO.workTimeStart}' pattern='yyyy-MM-dd HH:mm'/>"/></td>
	</tr>
	
	<tr>
		<td>工作開始時間:</td>
		<td><input name="workTimeEnd" id="endtime" type="text"
		 value="<fmt:formatDate value='${workTimeVO.workTimeEnd}' pattern='yyyy-MM-dd HH:mm'/>"/></td>
	</tr>

</table>
<br>
<input type="hidden" name="action" value="update">
<input type="hidden" name="workTimeNo" value="<%=workTimeVO.getWorkTimeNo()%>">
